        ...
        <div class="col-12">
            <div class="card mb-0">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('dashboard.upt.update', $upt->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            <div class="form-group">
                                ...
                                <input name="file" type="file" class="form-control input-image" accept="image/*">
                            </div>
                            <div class="form-group">
                                <label for="">NAMA UPT</label>
                                <input name="name" type="text" class="form-control" placeholder="cth: John Doe" value="{{ $upt->name }}" required>
                            </div>
                            <div class="form-group">
                                <label for="">DESKRIPSI</label>
                                <textarea name="description" class="form-control" rows="6" required>{{ $upt->description }}</textarea>
                            </div>
